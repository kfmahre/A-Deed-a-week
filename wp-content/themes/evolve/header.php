...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class(); ?>>
        ...
        if ($evolve_custom_background == "1") {
            ...
            if (get_post_meta($evolve_page_ID, 'evolve_slider_position', true) == 'above' || (get_post_meta($evolve_page_ID, 'evolve_slider_position', true) == 'default' && $evolve_slider_position == 'above')):
            ...
            <div class="menu-container">
                ...
                if ($evolve_width_layout == "fluid" && $evolve_menu_background == "1") {
                    ...
                    <div class="menu-back">
                        <?php
                        if (get_post_meta($evolve_page_ID, 'evolve_slider_position', true) == 'below' || (get_post_meta($evolve_page_ID, 'evolve_slider_position', true) == 'default' && $evolve_slider_position == 'below') || (is_home() && $evolve_slider_position == 'below')):
                            get_template_part('allslider');
                        endif;
                        ?>
